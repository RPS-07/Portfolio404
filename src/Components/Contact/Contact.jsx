...
const contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('your ServiceID', 'yourTemplateID', formRef.current, {
  ...
  return (
    ...
    >
        <motion.div className="textcontainer" variants={variants}>
            ...
            <motion.div className="item">
                <h2>Phone</h2>
                <span>+91 6239259699</span>
            </motion.div>
        </motion.div>
        <div className="formcontainer">
            <motion.div className="laptopsvg" 
            initial={{opacity:1}} 
            whileInView={{opacity:0}} 
            transition={{delay:3,duration:0.5}}>
            <svg fill="#000000" width="400px" height="400px" viewBox="0 0 64 64">
            <motion.path
            strokeWidth={0.5}
